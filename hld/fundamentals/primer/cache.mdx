...
### Web server caching
Reverse proxies and caches such as Varnish can serve static and dynamic content directly. Web servers can also cache
...
limited than disk, so cache invalidation algorithms such as least recently used (LRU) can help invalidate 'cold'
...
<Frame>
    <img src="images/cache-aside.png" alt="Cache-Aside" />
</Frame>
...
### Write-Through
<Frame>
    <img src="images/write-through.png" alt="Write-Through" />
</Frame>
...
<Frame>
    <img src="images/write-behind.png"/>
</Frame>
...
### Refresh-ahead
<Frame>
    <img src="images/refresh-ahead.png"/>
</Frame>
